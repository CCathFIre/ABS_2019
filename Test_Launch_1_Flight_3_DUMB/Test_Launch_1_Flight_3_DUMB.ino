...
void fullExtension(){  
  ...
  RETRACTONCE = false; // need to set the other bool to false so it executes the for loop when switcing over
...
void fullRetraction(){  
  ...
  EXTENDONCE = false; // need to set the other bool to false so it executes the for loop when switcing over
