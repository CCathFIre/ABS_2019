...
void loop() {
  ...
  Kalman(mpl_alt, accel_x); // Make sure you know how the sensor is oriented, it could be turned so that another axis is pointed up
...
void Print_Header() {
  ...
  if (dataFile) {
    ...
    dataFile.print("Kalman Z Acceleration\n"); dataFile.flush();
