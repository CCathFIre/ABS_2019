...
void ReadBestFlight(){
  ...
  if(inFile){
    while(inFile.available()){
      ...
      timet[c] = inFile.parseFloat() / 1000 ;
      acel[c] = (inFile.parseFloat()) * 0.3048; // our acel data was negative, sensor was oriented wrong in the test flight
      alt[c] = inFile.parseFloat() * 0.3048;
      c++;
    }
    inFile.close();
  }
